...
INSERT INTO movie_cinema (local_date_time, cinema_id, movie_id) VALUES
...
INSERT INTO accounts (address, age, city, country, name, postal_code, role, state) VALUES
...
INSERT INTO users (email, password, user_name, accounts_id) VALUES
                         ('josie_story@email.com', '123123123', 'josieStory', (SELECT id from accounts WHERE name = 'Josie D Story')),
                         ('bernard@email.com', '123123123', 'bernard', (SELECT id from accounts WHERE name = 'Bernard P Fendley')),
                         ('faith.p@email.com', '123123123', 'faith', (SELECT id from accounts WHERE name = 'Faith R Parsons')),
                         ('johnnie@email.com', '123123123', 'johnnie', (SELECT id from accounts WHERE name = 'Johnnie J Cannon')),
                         ('lawrence.f@email.com', '123123123', 'lawrence.f', (SELECT id from accounts WHERE name = 'Lawrence E Folkerts'));


INSERT INTO ticket (date_time, row_number, seat_number, movie_cinema_id, users_id) VALUES
                   ('2020-12-05 20:00:00', 14, 15, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 1 - EMPIRE') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Gentleman') LIMIT 1), (SELECT id from users WHERE email = 'josie_story@email.com')),
                   ('2020-12-05 20:00:00', 18, 7, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 1 - EMPIRE') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Gentleman') LIMIT 1), (SELECT id from users WHERE email = 'bernard@email.com')),
                   ('2020-12-05 20:00:00', 9, 9, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 1 - EMPIRE') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Gentleman') LIMIT 1), (SELECT id from users WHERE email = 'faith.p@email.com')),
                   ('2020-12-05 20:00:00', 12, 18, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 1 - EMPIRE') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Gentleman') LIMIT 1), (SELECT id from users WHERE email = 'johnnie@email.com')),
                   ('2020-12-05 20:00:00', 11, 5, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 1 - EMPIRE') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Gentleman') LIMIT 1), (SELECT id from users WHERE email = 'lawrence.f@email.com')),

                   ('2020-12-06 20:45:00', 14, 15, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 4 - SQUARE 13') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'Tenet') LIMIT 1), (SELECT id from users WHERE email = 'josie_story@email.com')),
                   ('2020-12-06 20:45:00', 18, 7, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 4 - SQUARE 13') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'Tenet') LIMIT 1), (SELECT id from users WHERE email = 'bernard@email.com')),
                   ('2020-12-06 20:45:00', 9, 9, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 4 - SQUARE 13') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'Tenet') LIMIT 1), (SELECT id from users WHERE email = 'faith.p@email.com')),
                   ('2020-12-06 20:45:00', 12, 18, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 4 - SQUARE 13') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'Tenet') LIMIT 1), (SELECT id from users WHERE email = 'johnnie@email.com')),
                   ('2020-12-06 20:45:00', 11, 5, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 4 - SQUARE 13') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'Tenet') LIMIT 1), (SELECT id from users WHERE email = 'lawrence.f@email.com')),

                   ('2020-12-07 21:30:00', 14, 15, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 2 - VILLAGE 7') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Nights Before Christmas') LIMIT 1), (SELECT id from users WHERE email = 'josie_story@email.com')),
                   ('2020-12-07 21:30:00', 18, 7, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 2 - VILLAGE 7') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Nights Before Christmas') LIMIT 1), (SELECT id from users WHERE email = 'bernard@email.com')),
                   ('2020-12-07 21:30:00', 9, 9, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 2 - VILLAGE 7') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Nights Before Christmas') LIMIT 1), (SELECT id from users WHERE email = 'faith.p@email.com')),
                   ('2020-12-07 21:30:00', 12, 18, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 2 - VILLAGE 7') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Nights Before Christmas') LIMIT 1), (SELECT id from users WHERE email = 'johnnie@email.com')),
                   ('2020-12-07 21:30:00', 11, 5, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 2 - VILLAGE 7') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Nights Before Christmas') LIMIT 1), (SELECT id from users WHERE email = 'lawrence.f@email.com')),

                   ('2020-12-08 19:00:00', 14, 15, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 3 - STREET 14') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Shawshank Redemption') LIMIT 1), (SELECT id from users WHERE email = 'josie_story@email.com')),
                   ('2020-12-08 19:00:00', 18, 7, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 3 - STREET 14') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Shawshank Redemption') LIMIT 1), (SELECT id from users WHERE email = 'bernard@email.com')),
                   ('2020-12-08 19:00:00', 9, 9, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 3 - STREET 14') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Shawshank Redemption') LIMIT 1), (SELECT id from users WHERE email = 'faith.p@email.com')),
                   ('2020-12-08 19:00:00', 12, 18, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 3 - STREET 14') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Shawshank Redemption') LIMIT 1), (SELECT id from users WHERE email = 'johnnie@email.com')),
                   ('2020-12-08 19:00:00', 11, 5, (SELECT id FROM movie_cinema WHERE cinema_id = (SELECT c.id FROM cinema c WHERE c.name = 'Hall 3 - STREET 14') AND movie_id = (SELECT m.id FROM movie m WHERE m.name = 'The Shawshank Redemption') LIMIT 1), (SELECT id from users WHERE email = 'lawrence.f@email.com'));
